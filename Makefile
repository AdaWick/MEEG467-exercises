connect-%: 
	...
	bash -c "docker -H $* pull adawick/duckiebot-meeg467:latest " 
	bash -c "docker -H $* run -it --net host --privileged -v /data:/data --name exercises adawick/duckiebot-meeg467:latest"
	bash -c "docker -H $* start exercises"
	bash -c "docker -H $* exec -it exercises /bin/bash"

copy-to-%: 
	bash -c "docker -H $* cp ~/MEEG467 exercises:/home/software/"

copy-from-%: 
	bash -c "docker -H $* cp exercises:/home/software/MEEG467 ~/"
