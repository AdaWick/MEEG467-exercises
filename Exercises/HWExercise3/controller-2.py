...
class Controller():
    ...
    #           rho_est    Estimation of distance to leader [m]
    #           theta_est  Estimation of angle to leader relative to 
    #                      forward direction [rad]
    #           psi_est    Estimate of leader's heading relative to follower's [rad]
    ...
    def getControlOutput(self, d_est, phi_est, d_ref, phi_ref, v_ref, rho_est, theta_est, psi_est, t_delay, dt_last):
